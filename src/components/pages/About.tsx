    ...
    <FlexColumn>
      ...
      <DefaultPageColumn>
        <AboutSurface title='The App' compact>
          ...
          <ButtonList>
            <LinkButton href='https://x.com' target='_newtab'>
              <GithubIcon color={iconColor} />
              Frontend
            </LinkButton>
            <LinkButton href='https://x.com'>
              <GithubIcon color={iconColor} />
              Backend
            </LinkButton>
            <LinkButton href='https://x.com'>
        ...
        <AboutSurface title='Me' compact>
          ...
          <ButtonList>
            ...
            <LinkButton href='https://discord.gg/'>
              <DiscordIcon color={iconColor} />
              Discord
            </LinkButton>
            <KofiButton id='V' label='Ko-fi' />
            <PatreonButton name='X' label='Patreon' />
          </ButtonList>
          <Divider />
          <Body>
            <p>Placeholder.</p>
